...
export default function Footer() {
  return (
    <footer
      className="bg-[#684040d6] text-center text-bl-600 dark:bg-black-600 dark:text-white-200 lg:text-left"
      >
      <div
        ...
        <div className="flex justify-center">
          <a className="mr-6 text-neutral-100 dark:text-neutral-200">
            <svg
      ...
      {/* <!--Copyright section--> */}
      <div className="text-white p-6 text-center dark:bg-bl-700">
